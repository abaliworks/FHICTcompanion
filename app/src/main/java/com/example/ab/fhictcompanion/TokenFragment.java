...
public class TokenFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FrameLayout fl = (FrameLayout) inflater.inflate(R.layout.fragment_token, container, false);

        WebView web = (WebView) fl.findViewById(R.id.webv_tok);
        ...
        web.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (url.contains("access_token=") && !authComplete) {
                    ...
                    authComplete = true;
                    Toast.makeText(getActivity(),"Authentication not successful",Toast.LENGTH_LONG).show();
                    closeFragment();
                }
            }
        });
